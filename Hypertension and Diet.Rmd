...
We will analyze the association of hypertension and diet in our study. We primaly used ANOVA analysis and Post Hoc analysis using survey weighted data to get our conclusion that:
...
From the two data summaries above, we can see that there are some categorical variables like race, gender, born place, diet, neighborhood incomes, income, diabetes, BMI, drink, and smoke.

The first step for these categorical variables is to change them to factors.
...
*MAT: I am not a huge fan of this logic. It does not seem all that flexible/reproducible to have a hard-coded value of 5 included here. I wonder if there is another way of automating this. Alternatively, writing a function that takes a list of variable names, for example, would be better, I think.*
