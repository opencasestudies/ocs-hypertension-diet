...
two models (logistic regression and survey-weighted logistic regression)
are different. We will discuss below which model is a better choice 
for this data set. 
...
[NYC HANES 2013-14 Blood Pressure Data](). 
...
All of them enable data users to understand the meaning and encoding of the variables better, and then complete the analysis more efficiently.
 
The NYC HANES is a population-based, cross-sectional study with data collected from a physical examination and laboratory tests, as well as a face-to-face interview and an audio computer-assisted self-interview (ACASI).
...
The [`haven` library]() is useful to import and export files from 
SAS, STATA, and SPSS. 
