...
## What is the data?
 ...
 [Questionaire](http://nychanes.org/wp-content/uploads/sites/6/2015/11/28283961_NYC-HANES-2013-14_Questionnaire.pdf). All of them enable data users to understand the meaning and encoding of the variables better, and then complete the analysis more efficiently.
...
Based on these data visualizations, potential relationship is revealed. So it is necessary to choose which varibles we might include in the formal statistical modeling. 
...
"Independent sampling design" means our sampling design is a simple random sample (SRS). By setting other parameters you can also specify different kinds of designs, such as stratified or clustered sampling, etc.
...
Now, let's interpret the new output. One catergorical variable and one continuous variable are chosen as examples:
