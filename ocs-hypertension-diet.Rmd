...
coefficients for `smoking` in this change.  Why did this happen? 

When we made plots to investigate the relationships between the variables, we found
there was a correlation between `smoking` and other variables.
So adding other variables to the model may change the, 
